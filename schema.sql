-- Supabase Database Schema for Full Stack Portfolio CMS
...
CREATE POLICY "Public Read About" ON about_section FOR SELECT USING (true);
...
CREATE POLICY "Public Read Contact" ON contact_socials FOR SELECT USING (true);
